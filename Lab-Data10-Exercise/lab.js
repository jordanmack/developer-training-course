...
async function validateLabCreate(skeleton)
{
	...
	for(let i = 0; i < 3; i++)
	{
		if(BigInt(tx.outputs[i].cell_output.capacity) !== ckbytesToShannons(104n))
		...
		if(new ScriptValue(tx.outputs[i].cell_output.type).hash() !== "0x68b82f41985e75fea6fdbb1eb79d8d98f1c7db1d14663440eb5749a3eb3bfa82")
...
async function validateLabConsume(skeleton)
{
	...
	for(let i = 0; i < 3; i++)
	{
		if(BigInt(tx.inputs[i].cell_output.capacity) !== ckbytesToShannons(104n))
		...
		if(new ScriptValue(tx.inputs[i].cell_output.type).hash() !== "0x68b82f41985e75fea6fdbb1eb79d8d98f1c7db1d14663440eb5749a3eb3bfa82")
