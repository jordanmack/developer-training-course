...
async function main()
{
	...
	// Locate all Live Cells with the desired data and add them as an inputs.
	...
	// Get the capacity sums of the outputs.
	const outputCapacity = transaction.outputs.toArray().reduce((a, c)=>a+hexToInt(c.cell_output.capacity), 0n);

	// Add the input cell to the transaction.
	const capacityRequired = outputCapacity + ckbytesToShannons(61n) + txFee; // output1 + output2 + minimum for a change cell + tx fee
