...
import {ckbytesToShannons, hexToArrayBuffer, hexToInt, intToHex, intToU32LeHexBytes, stringToHex} from "../lib/util.js";
...
const DATA_FILE_HASH_1 = ckbHash(hexToArrayBuffer(readFileToHexStringSync(DATA_FILE_1).hexString)); // Blake2b hash of the DataCap binary.
