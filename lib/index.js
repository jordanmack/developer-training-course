...
async function initializeLumosIndexer(nodeUrl)
{
	...
	await indexerReady(indexer, (indexerTip, rpcTip)=>console.log(`Syncing ${Math.floor(Number(indexerTip)/Number(rpcTip)*10_000)/100}% completed.`), {blockDifference: 1, timeoutMs: 0, recheckMs: 800});
	console.log();
