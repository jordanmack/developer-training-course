...
function intToU32LeHexBytes(num)
{
	...
	if(bigNum < 0n)
		console.error("Warning: A negative value was passed to intToU32LeHexBytes(). This usually means there has been a capacity miscalculation.");
...
function intToU64LeHexBytes(num)
{
	...
	if(bigNum < 0n)
		console.error("Warning: A negative value was passed to intToU64LeHexBytes(). This usually means there has been a capacity miscalculation.");
...
// Modified from source: https://stackoverflow.com/a/54646864/9979
